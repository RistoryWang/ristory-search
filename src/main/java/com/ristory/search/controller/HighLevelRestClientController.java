package com.ristory.search.controller;

import java.util.Map;

import com.ristory.search.service.HighLevelRestClientService;
...
public class HighLevelRestClientController {
	public static final PGLogger logger = PGLogger.create(HighLevelRestClientController.class);
